...
class Calculadora(tk.Tk):
    def __init__(self):
        ...
        #Caja de texto (input)
        self.entrada = None
        #StingVar obtine el valor del input
    ...
    def _creacion_componentes(self):
        #Creamoos un frame para la caja de texto
        ...
        #Frame para la parte de los botones
        botones_frame=tk.Frame(self, width=400, height=450, bg = 'grey')
        botones_frame.pack()

        #Primer renglón
        boton_limpiar = tk.Button(botones_frame, text='Limpiar', width='32', height=3, bd=0, bg='#eee', cursor='hand2', command=self._evento_limpiar)
